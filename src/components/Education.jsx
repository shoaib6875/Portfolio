        ...
        <div className="education-stairs">
          <div className="education-step step-1 fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="step-content bg-gradient-to-br from-blue-50 to-indigo-100 px-8 py-5 rounded-2xl shadow-lg card-hover floating-1 ml-[10px]">
              ...
              <p className={`text-gray-500 mb-3 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>2024 - 2027</p>
              <p className={`text-gray-600 mb-4 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                Pursuing a B.Tech with a focus on full-stack development, DevOps, and AI, with hands-on projects in AWS and MERN stack.
              </p>
              <div className="flex flex-wrap gap-2">
                ...
                <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm font-medium">AI/ML</span>
              </div>
            </div>
          </div>
